...
Public Class mainClass
    ...
    '                'Validations
    '                If errorCnt > 0 Then
    '                    frm_login.lbl_err.Text = String.Join(vbNewLine, msg) : frm_login.lbl_err.ForeColor = Color.Red
    '                    ctrlTxt(0).Select()
    '                    r = False
    '                Else
    ...
    '                        frm_login.lbl_err.Text = "Username does not exist." : frm_login.lbl_err.ForeColor = Color.Red
    '                        frm_login.txt_username.Select()
    '                        r = False
    '                    Else
    '                        'Check if password is correct
    '                        If usrData(5) <> inputPassword Then
    '                            frm_login.lbl_err.Text = "Incorrect Password." : frm_login.lbl_err.ForeColor = Color.Red
    '                            frm_login.txt_password.Select()
    '                            r = False
    '                        Else
    '                            'check online status
    '                            If usrData(4) = "True" Then
    '                                frm_login.lbl_err.Text = "User already logged in." : frm_login.lbl_err.ForeColor = Color.Red
    '                                frm_login.txt_password.Select()
    '                                r = False
    '                            Else
