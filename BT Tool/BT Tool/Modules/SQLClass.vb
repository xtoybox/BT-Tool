...
'    Public Function nQuery(ByVal quer As String, ByVal Optional bindings As String() = Nothing) As Integer
'        Init(quer, bindings)
'        Return Me.affected_rows
'    End Function

'    Public Function query(ByVal quer As String, ByVal Optional bindings As String() = Nothing) As DataTable
'        Init(quer, bindings)
'        Return Me.dtbl
'    End Function
...
'    Public Sub bind(ByVal field As String, ByVal value As String)
'        parameters.Add("@" & field & ChrW(127) & value)
'    End Sub

'    Public Sub bind(ByVal fields As String())
