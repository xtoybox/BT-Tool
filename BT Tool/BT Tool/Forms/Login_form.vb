Public Class Login_form
    ...
    Dim showpas As Image = My.Resources.show_pass_24
    Dim hidepas As Image = My.Resources.hide_pass_24
    ...
    Private Sub Login_form_Activated(sender As Object, e As EventArgs) Handles Me.Activated
