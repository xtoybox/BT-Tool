...
namespace markform
{
    public partial class frm_sub_monitoring : Form
    {
        ...
        #region Void Methods
        /// <summary>
        /// Setting the parameters of the selected tab
        /// </summary>
        /// <param name="clientname"></param>
        /// <param name="TabIndex"></param>
        /// <param name="dt">Current date selected</param>
        ...
        void OnNewMessage()
        {
            ...
            if (i.InvokeRequired)
            {
                SQLClass.NewMessage tempDelegate = new SQLClass.NewMessage(OnNewMessage);
