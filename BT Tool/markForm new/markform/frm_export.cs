...
namespace markform
{
    public partial class frm_export : Form
    {
        ...
        private SQLClass db = new SQLClass();
        ...
        /// <summary>
        /// Export Form <paramref name="args"/> Example:
        /// <para>New String[]{userID,username,position,department}</para>
        /// </summary>
        /// <param name="args"></param>
        /// <param name="type">Export type.eval, break, return, or flag</param>
        ...
        /// <summary>
        /// This will run the background worker for fetching data
        /// </summary>
