...
namespace markform
{
    public partial class frm_file_eval : Form
    {
        ...
        /// own, view, save
        /// </param>
        public frm_file_eval(object[] args = null,string viewtype = null)
        {
            InitializeComponent();
            if (args != null)
            {
                            ...
                            try
                            {
                                ...
                                else
                                {
                                    ...
                                    catch (Exception ex)
                                    {
                                        ...
                                        cf.WriteToFile("{0}==>" + ex.ToString()+"\n\n"+ ComparesPath+"\n\n"+ transferpath, Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\err.txt");
        ...
        private void DisplayUserList()
        {
            ...
            try
            {
                ...
                "department IN('bt', 'pr', 'bet') AND deactivated = 0 ORDER " +
                ...
                string[] depArr = new string[] { "bt", "pr", "bet" };
